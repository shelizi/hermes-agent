...
def test_an_acp_provider_turn_uses_sync_path_without_consumers(monkeypatch):
    """Quiet ACP turns use the whole-response path to avoid needless streaming."""
    agent, client = _agent(monkeypatch, "acp://somevendor")
