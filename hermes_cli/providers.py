...
HERMES_OVERLAYS: Dict[str, HermesOverlay] = {
    ...
    "devin-acp": HermesOverlay(transport="openai_chat", auth_type="external_process",
    ...
    "grok-acp": HermesOverlay(transport="openai_chat", auth_type="external_process",
                              base_url_override="acp://grok", base_url_env_var="GROK_ACP_BASE_URL",
                              extra_env_vars=("HERMES_GROK_ACP_COMMAND", "GROK_CLI_PATH", "HERMES_GROK_ACP_ARGS", "XAI_API_KEY")),
...
_ALIAS_GROUPS: Dict[str, Tuple[str, ...]] = {
    ...
    "devin-acp": ("devin", "devin-cli", "devin_cli", "devin_acp"),
    "grok-acp": ("grok-cli", "grok-build", "xai-grok-cli", "xai-grok-build", "grok_acp"), "vercel": ("ai-gateway", "aigateway", "vercel-ai-gateway"),
...
_LABEL_OVERRIDES: Dict[str, str] = {
    ...
    "copilot-acp": "GitHub Copilot ACP", "devin-acp": "Devin CLI ACP", "grok-acp": "Grok CLI ACP", "stepfun": "StepFun Step Plan", "xiaomi": "Xiaomi MiMo", "gmi": "GMI Cloud",
