...
_PLUGIN_COMPAT_LAZY = {
    ...
    '_build_oauth_catalog': ('hermes_cli.web_routers.oauth', '_build_oauth_catalog'),
    '_devin_acp_status': ('hermes_cli.web_server_oauth', '_devin_acp_status'),
    '_grok_acp_status': ('hermes_cli.web_server_oauth', '_grok_acp_status'),
