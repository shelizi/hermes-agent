...
def _external_process_status(provider_id: str, *, source_slug: str) -> Dict[str, Any]:
    try:
        ...
        raw = get_external_process_provider_status(provider_id) or {}
    except Exception as exc:
        return {
            "logged_in": False,
            "source": source_slug,
            "source_label": f"Managed by the {provider_id}",
            "token_preview": None,
            "expires_at": None,
    ...
    return {
        ...
        "configured": raw.get("configured", raw.get("cli_installed")),
    }
...
_OAUTH_PROVIDER_CATALOG: tuple[Dict[str, Any], ...] = (
    ...
    {"id": "devin-acp", "name": "Devin CLI (ACP)", "flow": "external", "cli_command": "devin auth login",
     "docs_url": "https://docs.devin.ai/cli", "status_fn": _devin_acp_status},
    {"id": "grok-acp", "name": "Grok CLI (ACP)", "flow": "external", "cli_command": "grok login",
     "docs_url": "https://docs.x.ai/build/cli", "status_fn": _grok_acp_status},
