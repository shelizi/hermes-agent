...
def _collect_gateway_skill_entries(
    ...
    try:
        ...
        # Build allowed roots from the local skills directory, any
        # user-configured skills.external_dirs, and trusted project dirs.
        # Normalize with os.path.commonpath instead of slash-delimited strings:
        ...
        _allowed_roots = [
            ...
            *(os.fspath(d) for d in get_project_skills_dirs()),
        ]
